...
from keras.layers import AveragePooling2D, Input, Flatten,Multiply,ReLU
...
class ResNet:
    ...
    def preprocess(self,data:CifarFix):
        data.preprocess(self._preprocess)
    ...
    def get_knowledge_model(self,restore=None):
        ...
        orgin=ResNet.resnet_v1_feature_extract(inputs)

        knowledge_input=FeatureExtractLayer()(inputs)
        knowledge_model=ResNet.resnet_v1_feature_extract(knowledge_input)
        x=Multiply()([orgin,knowledge_model])
